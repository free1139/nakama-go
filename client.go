...
func (c *Client) DeleteStorageObjects(session *Session, request api.DeleteStorageObjectsRequest) (bool, error) {
	if c.AutoRefreshSession && session.RefreshToken != "" &&
		session.IsExpired((time.Now().Unix()+c.ExpiredTimespanMs)/1000) {
		_, err := c.SessionRefresh(session, nil)
		if err != nil {
...
func (c *Client) EmitEvent(session *Session, request *api.Event) (bool, error) {
	if c.AutoRefreshSession && session.RefreshToken != "" &&
		session.IsExpired((time.Now().Unix()+c.ExpiredTimespanMs)/1000) {
		_, err := c.SessionRefresh(session, nil)
		if err != nil {
...
func (c *Client) ImportFacebookFriends(session *Session, request api.AccountFacebook) (bool, error) {
	if c.AutoRefreshSession && session.RefreshToken != "" &&
		session.IsExpired((time.Now().Unix()+c.ExpiredTimespanMs)/1000) {
		_, err := c.SessionRefresh(session, nil)
		if err != nil {
...
func (c *Client) ImportSteamFriends(session *Session, request api.AccountSteam, reset bool) (bool, error) {
	if c.AutoRefreshSession && session.RefreshToken != "" &&
		session.IsExpired((time.Now().Unix()+c.ExpiredTimespanMs)/1000) {
		_, err := c.SessionRefresh(session, nil)
		if err != nil {
...
func (c *Client) LinkApple(session *Session, request *api.AccountApple) (bool, error) {
	if c.AutoRefreshSession && checkStr(&session.RefreshToken) &&
		session.IsExpired((time.Now().Unix()+c.ExpiredTimespanMs)/1000) {
		_, err := c.SessionRefresh(session, nil)
		if err != nil {
...
func (c *Client) LinkCustom(session *Session, request *api.AccountCustom) (bool, error) {
	if c.AutoRefreshSession && checkStr(&session.RefreshToken) &&
		session.IsExpired((time.Now().Unix()+c.ExpiredTimespanMs)/1000) {
		_, err := c.SessionRefresh(session, nil)
		if err != nil {
...
func (c *Client) LinkDevice(session *Session, request *api.AccountDevice) (bool, error) {
	if c.AutoRefreshSession && checkStr(&session.RefreshToken) &&
		session.IsExpired((time.Now().Unix()+c.ExpiredTimespanMs)/1000) {
		_, err := c.SessionRefresh(session, nil)
		if err != nil {
...
func (c *Client) LinkEmail(session *Session, request *api.AccountEmail) (bool, error) {
	if c.AutoRefreshSession && checkStr(&session.RefreshToken) &&
		session.IsExpired((time.Now().Unix()+c.ExpiredTimespanMs)/1000) {
		_, err := c.SessionRefresh(session, nil)
		if err != nil {
...
func (c *Client) LinkFacebook(session *Session, request *api.AccountFacebook) (bool, error) {
	if c.AutoRefreshSession && checkStr(&session.RefreshToken) &&
		session.IsExpired((time.Now().Unix()+c.ExpiredTimespanMs)/1000) {
		_, err := c.SessionRefresh(session, nil)
		if err != nil {
...
func (c *Client) LinkFacebookInstant(session *Session, request *api.AccountFacebookInstantGame) (bool, error) {
	if c.AutoRefreshSession && checkStr(&session.RefreshToken) &&
		session.IsExpired((time.Now().Unix()+c.ExpiredTimespanMs)/1000) {
		_, err := c.SessionRefresh(session, nil)
		if err != nil {
...
func (c *Client) LinkGoogle(session *Session, request *api.AccountGoogle) (bool, error) {
	if c.AutoRefreshSession && checkStr(&session.RefreshToken) &&
		session.IsExpired((time.Now().Unix()+c.ExpiredTimespanMs)/1000) {
		_, err := c.SessionRefresh(session, nil)
		if err != nil {
...
func (c *Client) LinkGameCenter(session *Session, request *api.AccountGameCenter) (bool, error) {
	if c.AutoRefreshSession && checkStr(&session.RefreshToken) &&
		session.IsExpired((time.Now().Unix()+c.ExpiredTimespanMs)/1000) {
		_, err := c.SessionRefresh(session, nil)
		if err != nil {
...
func (c *Client) LinkSteam(session *Session, request *api.LinkSteamRequest) (bool, error) {
	if c.AutoRefreshSession && checkStr(&session.RefreshToken) &&
		session.IsExpired((time.Now().Unix()+c.ExpiredTimespanMs)/1000) {
		_, err := c.SessionRefresh(session, nil)
		if err != nil {
...
func (c *Client) Rpc(session *Session, id string, input map[string]interface{}) (*api.Rpc, error) {
	...
	return c.ApiClient.RpcFunc(&session.Token, &id, &jsonStr, nil, make(map[string]string))
}
...
func (c *Client) RpcHttpKey(httpKey, id string, input map[string]interface{}) (*api.Rpc, error) {
	...
	// Execute the RPC function on the API client
	return c.ApiClient.RpcFunc2(nil, &id, &inputJson, &httpKey, make(map[string]string))
}
...
func (c *Client) SessionRefresh(session *Session, vars map[string]string) (*Session, error) {
	...
	apiSession, err := c.ApiClient.SessionRefresh(&c.ServerKey, nil, &api.SessionRefreshRequest{
...
func (c *Client) UnlinkApple(session *Session, request *api.AccountApple) (bool, error) {
	if err := c.refreshSession(session); err != nil {
		return false, errors.As(err)
	}
...
func (c *Client) UnlinkCustom(session *Session, request *api.AccountCustom) (bool, error) {
	if err := c.refreshSession(session); err != nil {
		return false, errors.As(err)
	}
...
func (c *Client) UnlinkDevice(session *Session, request *api.AccountDevice) (bool, error) {
	if err := c.refreshSession(session); err != nil {
		return false, errors.As(err)
	}
...
func (c *Client) UnlinkEmail(session *Session, request *api.AccountEmail) (bool, error) {
	if err := c.refreshSession(session); err != nil {
		return false, errors.As(err)
	}
...
func (c *Client) UnlinkFacebook(session *Session, request *api.AccountFacebook) (bool, error) {
	if err := c.refreshSession(session); err != nil {
		return false, errors.As(err)
	}
...
func (c *Client) UnlinkFacebookInstantGame(session *Session, request *api.AccountFacebookInstantGame) (bool, error) {
	if err := c.refreshSession(session); err != nil {
		return false, errors.As(err)
	}
...
func (c *Client) UnlinkGoogle(session *Session, request *api.AccountGoogle) (bool, error) {
	if err := c.refreshSession(session); err != nil {
		return false, errors.As(err)
	}
...
func (c *Client) UnlinkGameCenter(session *Session, request *api.AccountGameCenter) (bool, error) {
	if err := c.refreshSession(session); err != nil {
		return false, errors.As(err)
	}
...
func (c *Client) UnlinkSteam(session *Session, request *api.AccountSteam) (bool, error) {
	if err := c.refreshSession(session); err != nil {
		return false, errors.As(err)
	}
...
func (c *Client) UpdateAccount(session *Session, request *api.UpdateAccountRequest) (bool, error) {
	if err := c.refreshSession(session); err != nil {
		return false, errors.As(err)
	}
...
func (c *Client) UpdateGroup(session *Session, groupId string, request *api.UpdateGroupRequest) (bool, error) {
	if err := c.refreshSession(session); err != nil {
		return false, errors.As(err)
	}
